...
#include <webots_ros2_interface/plugins/Ros2SensorPlugin.hpp>
#include <webots_ros2_interface/utils/Utils.hpp>

namespace webots_ros2_interface
{
  void Ros2SensorPlugin::init(webots_ros2_interface::WebotsNode *node, std::map<std::string, std::string> &parameters)
  {
    mNode = node;
    mLastUpdate = 0;
