...
class TestController(unittest.TestCase):
    ...
    def test_distance_sensors(self):
        ...
        print(subprocess.check_output(['ls', '../../../log/latest']))
        print(subprocess.check_output(['ls', '../../../log/latest/webots_ros2_examples']))
        print(subprocess.check_output(['cat', '../../../log/latest/webots_ros2_examples/stderr.log']))
        print(subprocess.check_output(['cat', '../../../log/latest/webots_ros2_examples/stdout.log']))
        print(subprocess.check_output(['cat', '../../../log/latest/webots_ros2_examples/stdout_stderr.log']))
        print(subprocess.check_output(['cat', '../../../log/latest/webots_ros2_examples/streams.log']))
        print(subprocess.check_output(['cat', '../../../log/latest/webots_ros2_examples/command.log']))
        print('---------------')
