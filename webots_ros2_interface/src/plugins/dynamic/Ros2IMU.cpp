...
#include <webots_ros2_interface/plugins/dynamic/Ros2IMU.hpp>

#include <webots_ros2_interface/utils/Math.hpp>
#include "pluginlib/class_list_macros.hpp"

namespace webots_ros2_interface
{
  void Ros2IMU::init(webots_ros2_interface::WebotsNode *node, std::map<std::string, std::string> &parameters)
  {
...
PLUGINLIB_EXPORT_CLASS(webots_ros2_interface::Ros2IMU, webots_ros2_interface::PluginInterface)
