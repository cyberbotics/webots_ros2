...
def generate_launch_description():
    ...
    trajectory_controller_spawner = Node(
        ...
        arguments=['ur_joint_trajectory_controller', '-c', 'ur5e/controller_manager'] + controller_manager_timeout  + ['--param-file', ros2_control_params],
    )
    ...
    joint_state_broadcaster_spawner = Node(
        ...
        output='screen',
        prefix=controller_manager_prefix,
        arguments=['ur_joint_state_broadcaster', '-c', 'ur5e/controller_manager'] + controller_manager_timeout  + ['--param-file', ros2_control_params],
    )
