...
wget https://github.com/cyberbotics/webots/releases/download/${WEBOTS_NIGHTLY_VERSION}/assets_2022b-rev1.zip -O /tmp/assets_2022b-rev1.zip
unzip -q /tmp/assets_2022b-rev1.zip -d ~/.cache/Cyberbotics/Webots/assets
