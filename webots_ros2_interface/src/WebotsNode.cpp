...
#include <webots_ros2_interface/plugins/static/Ros2Lidar.hpp>
#include <webots_ros2_interface/plugins/static/Ros2Camera.hpp>
#include <webots_ros2_interface/plugins/static/Ros2GPS.hpp>
#include <webots_ros2_interface/plugins/static/Ros2RangeFinder.hpp>
#include <webots_ros2_interface/plugins/static/Ros2DistanceSensor.hpp>
#include <webots_ros2_interface/plugins/static/Ros2LightSensor.hpp>
#include <webots_ros2_interface/plugins/static/Ros2LED.hpp>
  ...
  void WebotsNode::init()
  {
    ...
    for (int i = 0; i < mRobot->getNumberOfDevices(); i++)
    {
      ...
      case webots::Node::LIDAR:
        plugin = std::make_shared<webots_ros2_interface::Ros2Lidar>();
        break;
      case webots::Node::CAMERA:
        plugin = std::make_shared<webots_ros2_interface::Ros2Camera>();
        break;
      case webots::Node::GPS:
        plugin = std::make_shared<webots_ros2_interface::Ros2GPS>();
        break;
      case webots::Node::RANGE_FINDER:
        plugin = std::make_shared<webots_ros2_interface::Ros2RangeFinder>();
        break;
      case webots::Node::DISTANCE_SENSOR:
        plugin = std::make_shared<webots_ros2_interface::Ros2DistanceSensor>();
        break;
      case webots::Node::LIGHT_SENSOR:
        plugin = std::make_shared<webots_ros2_interface::Ros2LightSensor>();
        break;
      case webots::Node::LED:
        plugin = std::make_shared<webots_ros2_interface::Ros2LED>();
        break;
      }
      if (plugin)
      {
...
} // end namespace webots_ros2_interface
